...
public class OpenAiResponsesClient {
  ...
  public AiDtos.ModelProposal propose(String message, List<Map<String,Object>> projects, int isoYear, int isoWeek) {
    ...
    try {
      ...
      HttpResponse<String> response=HttpClient.newHttpClient().send(request,HttpResponse.BodyHandlers.ofString()); if(response.statusCode()<200||response.statusCode()>=300) unavailable();
    ...
    } catch(ResponseStatusException e){throw e;} catch(Exception e){unavailable(); return null;}
  }
