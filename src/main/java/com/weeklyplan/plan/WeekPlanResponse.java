...
public record WeekPlanResponse(
    ...
    String assignedBy, String assignedByUserId, boolean isAssigned, String status, Instant archivedAt, Long boardPosition,
    List<PlanParticipantResponse> participants, Instant createdAt, Instant updatedAt
) {}
