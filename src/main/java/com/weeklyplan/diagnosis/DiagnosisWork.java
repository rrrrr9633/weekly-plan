...
public class DiagnosisWork {
  ...
  @Column(name = "service_provider_contact") private String serviceProviderContact;
  ...
  public Long getId() { return id; } public Company getCompany() { return company; } public LocalDate getWorkDate() { return workDate; } public String getEnterpriseName() { return enterpriseName; } public String getAddress() { return address; } public String getCounty() { return county; } public String getDiagnosisTime() { return diagnosisTime; } public Integer getDiagnosisRound() { return diagnosisRound; } public String getServiceProviderContact() { return serviceProviderContact; } public AppUser getCreatedBy() { return createdBy; } public Set<AppUser> getParticipants() { return participants; } public Instant getCreatedAt() { return createdAt; } public Instant getUpdatedAt() { return updatedAt; }
  public static DiagnosisWork create(Company company, AppUser creator, LocalDate date, String enterpriseName, String county, String diagnosisTime, Integer diagnosisRound, String serviceProviderContact, Set<AppUser> participants) { DiagnosisWork work = new DiagnosisWork(); work.company = company; work.createdBy = creator; work.workDate = date; work.enterpriseName = enterpriseName; work.address = county; work.county = county; work.diagnosisTime = diagnosisTime; work.diagnosisRound = diagnosisRound; work.serviceProviderContact = serviceProviderContact; work.participants = new LinkedHashSet<>(participants); work.createdAt = Instant.now(); work.updatedAt = Instant.now(); return work; }
  public void update(LocalDate date, String enterpriseName, String county, String diagnosisTime, Integer diagnosisRound, String serviceProviderContact, Set<AppUser> participants) { this.workDate = date; this.enterpriseName = enterpriseName; this.address = county; this.county = county; this.diagnosisTime = diagnosisTime; this.diagnosisRound = diagnosisRound; this.serviceProviderContact = serviceProviderContact; this.participants = new LinkedHashSet<>(participants); this.updatedAt = Instant.now(); }
}
